...
The Unofficial Guide searches the `campus_life` corpus, a collection of short
posts about courses, housing, dining, and campus administration. It retrieves
the most relevant posts for a question and uses them to produce an answer with
source filenames. A relevance gate refuses questions when the retrieved
material is not close enough to support an answer.
